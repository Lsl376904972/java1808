...
<!DOCTYPE html>
<!-- saved from url=(0036)http://localhost:8080/cust/goods/add -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link href="./static/default.css" rel="stylesheet" id="lhgdialoglink">
    ...
    <link rel="icon" type="image/gif" href="http://localhost:8080/wxb/images/favicon.gif">
...
<div class="navbar navbar-default" id="navbar">
    ...
    <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
            <a href="http://localhost:8080/cust/index" class="navbar-brand">
                <small>
                    <i class="icon-leaf"></i>
                    微信公众号盈利平台-商户后台管理
                </small>
        ...
        <div class="navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="http://localhost:8080/cust/goods/add#" class="dropdown-toggle">
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        <li>
                            <a href="http://localhost:8080/cust/chpwd">
                                <i class="icon-cog"></i>
                                修改密码
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/setting">
                                <i class="icon-user"></i>
                                个人资料
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/logout">
                                <i class="icon-off"></i>
                                退出登录
                            </a>
                        </li>
...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        <a class="menu-toggler" id="menu-toggler" href="http://localhost:8080/cust/goods/add#">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                <li>
                    <a href="http://localhost:8080/cust/index">
                        <i class="icon-home"></i>
                ...
                <li class="active open">
                    <a href="http://localhost:8080/cust/goods/add#" class="dropdown-toggle">
                        <i class="icon-list"></i>
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/goods/copy/add?tp=0">
                                <i class="icon-pencil"></i>
                                增加微信文案
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/goods/copy/add?tp=1">
                                <i class="icon-pencil"></i>
                                增加站内文案
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/goods/copy/add?tp=2">
                                <i class="icon-pencil"></i>
                                增加空间文案
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/list">
                                <i class="icon-double-angle-right"></i>
                                全部的订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/list/1">
                                <i class="icon-double-angle-right"></i>
                                已下单订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/list/9">
                                <i class="icon-double-angle-right"></i>
                                待跟进订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/list/2">
                                <i class="icon-double-angle-right"></i>
                                待发货订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/list/3">
                                <i class="icon-double-angle-right"></i>
                                已取消订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/list/4">
                                <i class="icon-double-angle-right"></i>
                                已发货订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/list/5">
                                <i class="icon-double-angle-right"></i>
                                已结算订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/list/6">
                                <i class="icon-double-angle-right"></i>
                                已拒收订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/list/7">
                                <i class="icon-double-angle-right"></i>
                                已签收订单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/list/8">
                                <i class="icon-double-angle-right"></i>
                                已退货订单
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/report/good">
                                <i class="icon-double-angle-right"></i>
                                商品销售统计
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/count/1">
                                <i class="icon-double-angle-right"></i>
                                待结算流水
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/count/2">
                                <i class="icon-double-angle-right"></i>
                                已结算流水
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/count/3">
                                <i class="icon-double-angle-right"></i>
                                已返款流水
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/money">
                                <i class="icon-double-angle-right"></i>
                                财务返款单
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="http://localhost:8080/cust/order/paylog">
                                <i class="icon-double-angle-right"></i>
                                支付宝记录
                            </a>
                        </li>
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    <li>
                        ...
                        <a href="http://localhost:8080/cust/index">首页</a>
                    </li>

                    <li>
                        <a href="http://localhost:8080/cust/goods/list">商品管理</a>
                    </li>

                    <li>
                        <a href="http://localhost:8080/cust/goods/add">增加商品</a>
                    </li>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="lbl">&nbsp;<a href="http://localhost:8080/cust/goods/add#">11</a></span><br>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="lbl">&nbsp;<a href="http://localhost:8080/cust/goods/add#">12</a></span><br>
    ...
    <a href="http://localhost:8080/cust/goods/add#" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse">
