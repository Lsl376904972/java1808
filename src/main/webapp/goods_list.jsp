...
<!DOCTYPE html>
<!-- saved from url=(0037)http://localhost:8080/cust/goods/list -->
    ...
    <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="http://localhost:8080/cust/goods/list#" class="dropdown-toggle">
...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        <a class="menu-toggler" id="menu-toggler" href="http://localhost:8080/cust/goods/list#">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <li class="active open">
                    <a href="http://localhost:8080/cust/goods/list#" class="dropdown-toggle">
                        <i class="icon-list"></i>
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <div class="nav-search" id="nav-search">
                    <form name="formSelect" method="post" action="http://localhost:8080/cust/goods/list">
            ...
            <a href="http://localhost:8080/cust/goods/list#" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse">
